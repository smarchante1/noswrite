...
export default function App() {
  ...
  const [syncUrl, setSyncUrl] = useState(
    () => localStorage.getItem('noswrite-sync-url') || '',
  );
  ...
  const handleCloudPull = async () => {
    ...
    try {
      ...
      if (Array.isArray(parsed) && parsed.length > 0 && parsed[0].id) {
        ...
        alert('Project successfully synced from local server!');
      } else {
          ...
          >
            ...
            >
              ...
              <p className="text-slate-500 font-light text-sm leading-relaxed">
                Configure your local network sync to seamlessly push and pull
                your data between computers. Look at your terminal output for
                your Network IP!
              </p>
              <div className="space-y-4 pt-2">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. http://192.168.1.XXX:5173/api/sync"
